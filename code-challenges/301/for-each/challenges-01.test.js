...
let speaker = function (message, callback) {
...
let addValues = function (arr, value) {
  arr.push(value);
};
// addValues([], 9); 
let myArr = [];
let addNumbers = function (value, arr, times, callback) {
  for (let i = 0; i < times; i++) {
    callback(arr, value);
  }
  return arr;
};
console.log(addNumbers(4, myArr, 6, addValues));
/* ------------------------------------------------------------------------------------------------
CHALLENGE 3
...
Return the modified array.
------------------------------------------------------------------------------------------------ */
let removeOneArr = [4, 4, 5, 6, 2];
let removeOne = function (num, arr) {
  if (num % 3 === 2) {
    arr; //?
    arr.pop();
    arr; //?
...
let removeElements = function (arr, callback) {
...
var removeWithForEach = function (arr, callback) {
  console.log(arr);
...
let removeWithAnon = function (arr) {
...
let feeder = [1, 2, 3, 4, 5, 6, 7, 8, 9];
removeWithAnon(feeder); //?
/* 
...
let createList = function (availableItems) {
  let myList = [];
